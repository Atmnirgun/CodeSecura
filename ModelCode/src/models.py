...
class CodeSecura_Vanilla(torch.nn.Module):
...
class CodeSecura_Extend(torch.nn.Module):
    def __init__(self,base_model,n_clases,base_model_output_size=768, dropout=0.1):
        super().__init__()
...
class CodeSecura_CNN(torch.nn.Module):
...
class CodeSecura_LSTM(torch.nn.Module):
    def __init__(self,base_model,n_clases,base_model_output_size=768, dropout=0.2):
        super().__init__()
